...
[Generator]
internal class RevitApplicationFactoryGenerator : IncrementalGeneratorBase
{
    public override void Initialize(IncrementalGeneratorInitializationContext context)
    {
        var pipeline = context.SyntaxProvider.ForAttributeWithMetadataName(
            "Scotec.Revit.LoadContext.RevitApplicationIsolationAttribute",
    ...
    private static void Execute(SourceProductionContext sourceContext, GeneratorAttributeSyntaxContext syntaxContext)
    {
        ...
        var template = LoadTemplate("RevitApplicationFactory");
